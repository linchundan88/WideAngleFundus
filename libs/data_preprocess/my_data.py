...
split_dataset   (split dataset into training and predict datasets)
split_dataset_cross_validation

split_dataset_by_pat_id
  (split dataset into training and predict datasets, and suppose pat_id is the prefix of image filename)
...
# get_list_from_dir and write to csv,  label all 0, used for predict
