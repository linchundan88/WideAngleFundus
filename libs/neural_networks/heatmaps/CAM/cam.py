...
def __getCAM(feature_conv, weight_fc, class_idx):
...
def get_cam(model, inputs, layer_name_conv, layer_name_fc='fc', class_idx=None):
    model.eval()
    ...
    overlay = __getCAM(features, weight_softmax, class_idx)
